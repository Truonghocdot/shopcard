<div class="glass rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
    ...
    <div class="px-6 pt-6 text-[10px] md:text-xs">
        <div class="p-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl flex items-center gap-3 font-black uppercase tracking-widest">
    ...
    <div class="px-6 pb-6 pt-6">
        <div class="bg-white/5 rounded-2xl p-6 border border-white/5">
            <h3 class="text-primary font-black mb-3 flex items-center gap-2 uppercase tracking-widest text-xs">
                ...
                {{ __('profile.referral_link') }}
            </h3>
            <p class="text-neutral-600 text-[10px] mb-6 font-bold uppercase tracking-widest">{{ __('profile.referral_desc') }}</p>
            ...
            <div class="flex gap-2">
                ...
                <button
                    type="button"
                    onclick="navigator.clipboard.writeText('{{ $this->affiliateUrl }}'); alert('{{ __('profile.referral_copied') }}');"
            ...
            <div class="mt-4 grid grid-cols-2 gap-4">
                <div class="bg-neutral-950/40 border border-white/5 rounded-xl p-4">
                    <p class="text-neutral-600 text-[9px] uppercase font-black tracking-widest mb-1">{{ __('profile.referred_users') }}</p>
                    <p class="text-white font-black text-2xl tracking-tighter">{{ auth()->user()->referrals()->count() }}</p>
                </div>
                <div class="bg-neutral-950/40 border border-white/5 rounded-xl p-4">
                    <p class="text-neutral-600 text-[9px] uppercase font-black tracking-widest mb-1">{{ __('profile.total_commission') }}</p>
    ...
    <form wire:submit.prevent="updateProfile" class="p-6 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="space-y-3">
                <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('full_name') }}</label>
            ...
            <div class="space-y-3">
                <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('phone_number') }}</label>
                <div class="relative group">
            ...
            <div class="space-y-3">
                <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('email_address') }}</label>
                <div class="relative group">
        ...
        <div class="border-t border-white/5 pt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-3" x-data="{ show: false }">
                    <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('profile.current_password') }}</label>
                ...
                <div class="space-y-3" x-data="{ show: false }">
                    <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('profile.new_password') }}</label>
                    <div class="relative w-full group">
                ...
                <div class="space-y-3" x-data="{ show: false }">
                    <label class="text-neutral-600 text-[10px] font-black uppercase tracking-widest pl-1">{{ __('profile.confirm_new_password') }}</label>
                    <div class="relative w-full group">
